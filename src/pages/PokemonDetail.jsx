...
function PokemonDetail({
  ...
  function handleAbilityAIAnalysis(event, abilityKey) {
    ...
    // Si ya existe un análisis completado para esta misma habilidad en el mismo contexto, simplemente abrimos el Focus Mode sin relanzar request
    if (aiTargetAbility === targetKey && aiData && aiStatus === AI_STATUS.SUCCESS) {
      return
    }

    // Si ya está cargando esta misma habilidad, no lanzar otra request simultánea, solo abrir el Focus Mode
    if (aiTargetAbility === targetKey && aiStatus === AI_STATUS.LOADING) {
      return
    }
              ...
              return (
                ...
                >
                  ...
                  <div className="ability-panel-body">
                    ...
                    {/* Botón único de PokeGuide AI para abrir AbilityAIFocusMode */}
